...
export default function ProductCard({ product }) {
  ...
  return (
    <motion.div
      ...
      className="glass rounded-[32px] overflow-hidden group border border-white/60 hover:shadow-2xl transition-all flex flex-col h-full cursor-pointer bg-white/40 backdrop-blur-md"
    >
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <p className="text-muted-foreground text-[10px] line-clamp-2 mt-2 mb-4 leading-relaxed font-medium">
        ...
        <div className="mt-auto flex items-center justify-between pt-4 border-t border-slate-50">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-slate-50/50 border border-slate-100">
            <Layers size={12} className="text-primary/40" />
            <span className="text-[10px] font-black text-foreground">{product.stock_count || 0}</span>
          </div>
        </div>
      </div>
    </motion.div>
